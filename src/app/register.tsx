...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: '700', color: '#14171C', marginTop: 10 },
  subtitle: { fontSize: 13, color: '#5B6472', marginBottom: 20 },
  ...
  applyUrlBtn: { backgroundColor: '#3A4250', height: 40, borderRadius: 8, justifyContent: 'center', alignItems: 'center' },
  ...
  loginLinkText: { color: '#FF6A13', fontSize: 13, fontWeight: '600' },
});